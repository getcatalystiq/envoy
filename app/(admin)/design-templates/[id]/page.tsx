...
export default function DesignTemplateEditorPage() {
    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-center">
          ...
          <Button variant="outline" className="mt-4" onClick={() => router.push('/design-templates')}>
            Back to Templates
          </Button>
        </div>
      </div>
    ...
    <div className="h-screen flex flex-col">
      <div className="border-b px-4 py-3 flex items-center justify-between bg-background relative z-50">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" onClick={() => router.push('/design-templates')}>
