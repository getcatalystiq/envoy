...
const ALLOWED_UPDATE_COLUMNS = new Set([
  "email", "first_name", "last_name", "company", "phone", "phone_normalized",
  "target_type_id", "segment_id", "lifecycle_stage", "custom_fields", "metadata", "status",
]);
...
export async function getAll(
  ...
  const { status, targetTypeId, segmentId, lifecycleStage, limit: rawLimit = 100, offset = 0 } = opts;
